...
const Navbar = () => {
    ...
    return (
        <div className="relative w-full flex items-center justify-between z-20 p-4 bg-gray-800 text-white">
            ...
            <Button className="w-xs font-primary w-full text-xs md:text-xl cursor-pointer" onClick={handleGoToFavourites} name="FAVOURITES" />
            <Button className=" w-xs font-primary w-full text-xs md:text-xl cursor-pointer" onClick={handleGoToAboutUs} name="ABOUT US" />
            <Button />
        </div>
    )
}
